			...
			<form id="signin" action="/login_script.php" name="signin" method = "post">
				<table width="309" border="0" align="center" cellpadding="2" cellspacing="5">
					<tr>
						<td colspan="2">
								 <?php
									if( isset($_SESSION['LOGIN_ERROR_ARRAY']) && is_array($_SESSION['LOGIN_ERROR_ARRAY']) && count($_SESSION['LOGIN_ERROR_ARRAY']) >0 ) {
									echo '<ul class="err">';
									foreach($_SESSION['LOGIN_ERROR_ARRAY'] as $msg) {
										echo '<li>',$msg,'</li>';
									}
										echo '</ul>';
										unset($_SESSION['LOGIN_ERROR_ARRAY']);
									}
								?>
						</td>
					</tr>
