...
//			setTimeout(alert("blah"), 3000);
	...
	<body>
		<div class="headpage">
			...
			<a href="/index.html"><img class="pagelogo" src="/images/shadymart.png" alt="ShadyMart"/></a>
			...
			<ul>
				...
				<?php
				//echo '<li class="active">Hello Idiot!</li>';
			...
			<input type="button" id="cart" class="shoppingcart" onclick="ShoppingCart()"/>
		</div>
		<div id = "showcase1" class="showcase">
			<h1 class="deals">Khajit has wares if you have coin.</h1>
			<img id="w3" src="/images/boxart1.jpg" class="thumbnail" alt="Witcher3" width="200" height="200">
			<figcaption>The Witcher 3:Wild Hunt(PC)<br>50% Off</figcaption>
			<img id="nike" src="/images/sports1.jpg" class="thumbnail" alt="nike" width="200" height="200">
			<figcaption id="nikedesc">Nike Hypervenom Phantom Premium<br> football studs</figcaption>
		</div>
		</div>
		<div class="page-end">
